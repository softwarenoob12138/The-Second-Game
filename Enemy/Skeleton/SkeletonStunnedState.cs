...
public class SkeletonStunnedState : EnemyState
{
    ...
    public override void Enter()
    {
        ...
        enemy.fx.InvokeRepeating("RedColorBlink", 0, .1f);  //Unity专属函数，允许在 0 秒后开始，每隔 .1f 秒后调用一次 RedColorBlink 方法
    ...
    public override void Exit()
    {
        ...
        enemy.fx.Invoke("CancelColorChange", 0);  //在 0 秒后调用 CancelRedBlink 方法
    }
